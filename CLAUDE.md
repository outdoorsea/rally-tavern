...
**YOU ARE IN: `rally_tavern/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/rally_tavern/` (rig root) or other directories
...
**Your mail address:** `rally_tavern/polecats/rust`
**Your rig:** rally_tavern
**Your Witness:** `rally_tavern/witness`
...
| Ask Witness for help | `gt mail send rally_tavern/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`rally_tavern/witness`) when:
...
```bash
gt mail send rally_tavern/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
